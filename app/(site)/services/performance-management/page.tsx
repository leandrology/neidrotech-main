...
export const metadata: Metadata = {
  title: "Performance Management & Payroll Processing - Niedrotech",
  description:
    "This is Performance Management & Payroll Processing for Niedrotech",
  // other metadata
};

const PerformanceManagement = async () => {
  return (
    <>
