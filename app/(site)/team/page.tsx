          ...
          <SectionHeader
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
              <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-black dark:text-white">
                  <a href="#">
                    <Image
                      width={200}
                      height={200}
                ...
                <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-black">
                  <a href="#">
                    <Image
                      width={200}
                      height={200}
                  ...
                  <div className="p-5">
                    ...
                    <span className="text-gray-500 dark:text-white">Chairman & CTO</span>
                    <p className="mt-3 mb-4 font-light text-gray-500 dark:text-white">
