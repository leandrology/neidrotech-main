...
const faqData: FAQ[] = [
  {
    id: 1,
    quest: "What IT services does Neidrotech offer?",
    ans: "Neidrotech provides a comprehensive suite of IT solutions to empower businesses of all sizes. Our services encompass cloud management, network optimization, cybersecurity measures, IT consulting, and ongoing support. We can help you design, implement, and manage your IT infrastructure to streamline operations, enhance security, and achieve your business goals.",
  },
  {
    id: 2,
    quest: "How does Neidrotech approach IT security?",
    ans: "At Neidrotech, we understand the critical importance of cybersecurity in today's digital landscape. We take a multi-layered approach to security, offering threat detection and prevention solutions, vulnerability assessments and patching, secure network architecture design, and ongoing security awareness training for your staff. We stay up-to-date on the latest cyber threats and implement proactive measures to safeguard your data and systems.",
  },
  {
    id: 3,
